...
namespace Controladores
{
    public class PisoControlador : IControlador<Piso>
    {
        ...
        public async Task<Piso> add(Piso tareaNueva)
        {
            ...
            HttpResponseMessage mensaje = await cliente.PostAsync("http://192.168.1.104:8080/api/pisos", content);
        ...
        public async Task<List<Piso>> getAll()
        {
            try
            {
                ...
                HttpResponseMessage mensaje = await cliente.GetAsync("http://192.168.1.104:8080/api/pisos");
        ...
        {
            Piso piso = new Piso();
            HttpResponseMessage mensaje = await cliente.GetAsync($"http://192.168.1.104:8080/api/pisos/{id}");
            mensaje.EnsureSuccessStatusCode();
            string mensajeJson = await mensaje.Content.ReadAsStringAsync();
        ...
        {
            HttpResponseMessage mensaje = await cliente.DeleteAsync($"http://192.168.1.104:8080/api/pisos/{id}");
            mensaje.EnsureSuccessStatusCode();
            return true;
        }
        ...
        public async Task<Piso> update(Piso tareaModificada, int id)
        {
            ...
            HttpResponseMessage mensaje = await cliente.PutAsync($"http://192.168.1.104:8080/api/pisos/{id}", content);
            mensaje.EnsureSuccessStatusCode();
